...
var instrucciones = ["Mover las piezas hasta lograr la imagen del obejetivo final","Tendras un numero limitado de movimientos para lograr el objetivo","Una vez logrado, mezcla las piezas y desafia a un amigo"];
...
function mostrarCartelGanador() {
    alert("FELICITACIONES!...ganaste. Ahora vuelve a mezclar las piezas y desafia a un amigo.")
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    var auxPosicion = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = auxPosicion;
